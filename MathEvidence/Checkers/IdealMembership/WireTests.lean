...
example :
    digestOfRequestFields parityCapability parityClaim none =
      .ok ⟨"sha256:a25e551485df42cb0302c98d7eae8c590759a8d40f49257d335431f458578c3e"⟩ := by
  native_decide

example :
    digestOfRequestFields parityCapability parityClaim
        (some ["semantic note", "second note"]) =
      .ok ⟨"sha256:f189ced92b8824681b10bd30368c4e86aecf947e3607fe2161b3eeea96a3954e"⟩ := by
  native_decide
